...
# CRS 
  ...
  mutate(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )` = case_when(
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "VGPR")        ~ "VGPR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "PR")          ~ "PR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "evaluable")   ~ NA_character_,
    `Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )` == "CR"	                   ~ "CR, MRD unknown",
    `Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )` == "CR, MRD+"	             ~ "CR, MRD+",
    
    `Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )` == "sCR, MRD+"           	 ~ "sCR, MRD+",
    `Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )` %in% c(
    ...
    TRUE           ~ `Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`
  )) %>% 
  mutate(ORR_30days = case_when(
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "CR")   ~ "ORR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "PR")   ~ "ORR",
    is.na(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`)              ~ NA_character_,
    TRUE                                                                        ~ "PD/SD/MR"
  )) %>% 
  mutate(MRDneg_30days = case_when(
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "MRD-")        ~ "Yes",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "MRD")         ~ "No",
    TRUE                             ~ NA_character_
  )) %>% 
  mutate(day30_response = case_when(
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "VGPR")        ~ "VGPR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "PR")          ~ "PR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "sCR")	       ~ "sCR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "CR")	         ~ "CR",
    is.na(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`)                     ~ NA_character_,
    TRUE           ~ `Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`
  )) %>% 
  mutate(day30_response_group = case_when(
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "VGPR")        ~ "VGPR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "PR")          ~ "PR",
    str_detect(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`, "CR")	         ~ "CR or sCR",
    is.na(`Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`)                     ~ NA_character_,
    TRUE           ~ `Day 30 Response (sCR, CR, VGPR, PR and MRD+ vs MRD- )`
  )) %>% 
...
cart2 %>% 
  ...
  filter(value == "YES") %>% 
  # unite(time, c("day":"me"), sep = " ") %>% 
  ggplot(aes(x= name, y= perc, fill= name, alpha= grade))+
...
```{r}
cart2 %>% 
  mutate(`CMV IgG apheresis` = case_when(
    `CMV IgG apheresis` == "0"         ~ "negative",
    `CMV IgG apheresis` == "1"         ~ "immune"
  )) %>% 
  mutate(`CMV IgG D90 (1=pos, 0=neg)` = case_when(
    `CMV IgG D90 (1=pos, 0=neg)` == "0"         ~ "negative",
    `CMV IgG D90 (1=pos, 0=neg)` == "1"         ~ "immune"
  )) %>% 
  select(PT, 
