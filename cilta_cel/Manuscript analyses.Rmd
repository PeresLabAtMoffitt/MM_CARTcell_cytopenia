...
## Supportive therapies and engraftment
...
## Details of infections after ide-cel
Jenn
 

## Patients with infections in the first 30 days by CRS, ICANS, tocilizumab use, steroid use, anakinra use and bridging therapy
```{r}
cilta %>% 
  distinct(pt_identifier, .keep_all = TRUE) %>% 
...
## Patients with infections in the first 100 days by cell counts and immunoglobulin levels
