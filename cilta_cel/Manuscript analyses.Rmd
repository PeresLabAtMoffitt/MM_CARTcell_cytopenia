...
## Table S4. Patient characteristics by grade 3+ cytopenia at Day 30
...
## Table S5. Patient characteristics by grade 3+ cytopenia at Day 90
...
## Table S6. CRS, ICANS, tocilizumab use, steroid use, anakinra use and bridging therapy by grade 3+ cytopenia at Day 30
...
fig_dat %>% 
  ...
  select(phrase, `cause of death` = cause_of_death_myeloma_toxicitiy_unrelated,
         `CRS grade` = max_crs_grade_0_5, `delayed neurotoxicity` = delayed_neuro_type)
```
