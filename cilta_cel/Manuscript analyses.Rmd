...
# ggsave("Figure S1 Inflammatory markers after cilta-cel.pdf",
#        width = 6,
#        height = 10)
```
...
# ggsave("Figure 2 Cellular and humoral immune reconstitution after cilta-cel.pdf",
#        width = 15, 
#        height = 8)
```
<br>
...
c %>% filter(grade == "Grade 3+") %>% 
  ...
  geom_bar(stat = "identity",
           position=position_dodge(width=0.9))+
  geom_text(aes(label = paste0(round(perc, 0), "%"), y=perc-2), size = 3,
...
# ggsave("Figure 3 Cytopenias over time.pdf",
#        width = 7,
#        height = 4)
...
a <- cilta %>%
  ...
  labs(x = NULL, y = "Infection onset time (days)")+
...
# ggsave("Figure 4 Infection density.pdf",
#        width = 7,
#        height = 10)
...
# ggsave("Figure S3. Viral titers after cilta-cel.pdf",
#        width = 7,
#        height = 10)
```
...
# ggsave("Figure S3+day180 Viral titers after cilta-cel.pdf",
#        width = 7,
#        height = 10)
```
...
# ggsave("Figure S2 Forest plot 5 variables.pdf", 
#        device = cairo_pdf,
#        width = 7,
#        height = 6)
...
# ggsave("Survival panel.pdf", device = cairo_pdf,
#        path = paste0(here::here(), "/cilta_cel"), 
#        width = 14, height = 11, 
#        units = c("in"), 
#        dpi=600, 
