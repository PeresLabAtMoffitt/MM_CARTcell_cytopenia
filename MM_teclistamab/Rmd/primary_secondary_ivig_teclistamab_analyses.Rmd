...
survfit(Surv(os_from_initiation_months, os_event) ~ ivig_cat, data = bsab_data)
```
...
summary(survfit(Surv(os_from_initiation_months, os_event) ~ ivig_cat, data = bsab_data), times = c(3,6,9,12))
```


```{r Survival analysis - KM by ivig_cat}
ggsurvplot(survfit(Surv(os_from_initiation_months, os_event) ~ ivig_cat, 
                   data = bsab_data),
           # title = "PFS Analysis",
...
summary(survfit(Surv(pfs_from_initiation_months, pfs_event) ~ ivig_cat, data = bsab_data), times = c(3,6,9,12))
```

```{r PFS analysis - KM by ivig_cat}
ggsurvplot(survfit(Surv(pfs_from_initiation_months, pfs_event) ~ ivig_cat, 
                   data = bsab_data),
           # title = "PFS Analysis",
           font.main = c(20, "bold", "black"),
           font.x = c(15, "bold", "black"),
