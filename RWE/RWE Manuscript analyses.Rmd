...
`r emo::ji("question_mark")` **Exclusion criteria**
...
```{r, fig.width= 6, fig.height=6}
ggsurvplot(survfit(Surv(days_at_pfs_from_infusion, pfs_event) ~ Did_patient_met_criteria_for_KarMMa1_pre_CAR_T, 
                   data = cart0),
           title = "PFS from date of infusion", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
...
Panel C: OS Kaplan Meier (from CAR-T infusion)
```{r, fig.width= 6, fig.height=6}
ggsurvplot(survfit(Surv(days_at_os_from_infusion, os_event) ~ Did_patient_met_criteria_for_KarMMa1_pre_CAR_T, 
                   data = cart0),
           title = "OS from date of infusion", 
           font.main = c(24, "bold", "black"), 
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"), 
