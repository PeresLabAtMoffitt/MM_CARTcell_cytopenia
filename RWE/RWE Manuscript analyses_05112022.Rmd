...
var_label(cart0) <- list(Age = "Patient Age", agecat = "Patient Age - Categories", 
                       ...
                       comorbidities = "Any comorbid conditions", time_leukapheresis_infusion = "Time from leukapheresis to infusion, days",
...
cart0 %>% 
  select(Age, agecat, male_sex, Sex,
         ...
         time_leukapheresis_infusion, time_leukapheresis_fup) %>% 
  tbl_summary(
    type = list(
      c(
      `Extramedullary Disease? (Yes, No)`, 
...
tbl2 <- list(
    ...
    # survfit(Surv(days_at_pfs_from_infusion, pfs_event) ~ age, 
    #                data = cart1),
